...
\vspace{30mm}
\centerline{
  \includegraphics[width=0.75\textwidth]{image/Beihang_University_Logo.svg.png}
}
\newpage
...
全文大致内容如下：
\begin{itemize}
  \item \textcolor{red}{title}：Compressor surge and stall propagation
  \item \textcolor{red}{abstract}：
  \item \textcolor{red}{introduction}：
  \item \textcolor{red}{chapter}：
  \item \textcolor{red}{conclusion}：
  \item \textcolor{red}{references}：
\end{itemize}
